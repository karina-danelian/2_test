...
fun main() {
    ...
    val ironRuda = 11
    val percent = 20
    var crystalBuff = percent  * crystalRuda
    crystalBuff /= 100
    var ironBuff = percent * ironRuda
    ironBuff /=  100
    print(crystalBuff)
    println(" Кристаллическая руда")
    print(ironBuff)
    println(" Железная руда")
...
заранее известные данные, объявить и проинициализировать. Напиши программу,
 которая будет учитывать действие баффа и выводить в консоль количество “бонусных”
